...
def load_dataset(filepath: Optional[Union[str, Path]] = None) -> KnowledgeGraphStore:
    """Loads knowledge graph from a JSON file. If file does not exist, generates synthetic data."""
